...
// TODO Make sure you have the latest tester file! @SuppressWarnings("deprecation")
public class BaseTester {
				...
				if ((line1 != null) && (line2 != null)) {
					if (!line1.trim().equals(line2.trim())) {
						...
						if (!line1.equals(line2)) {
							System.out
									.println("WARNING: Mismatch found on line "
											+ count + " of "
											+ path1.getFileName());
							return false;
						}
	 ...
	 * and then tests the output. The expected output file should always be in
	 * the "output" subdirectory of the base directory. The actual output file
	 * should be in the current working directory.
	 * 
	 * @param args
	 *            arugments to pass to the Driver class
	 * @param expected
	 *            name of the expected output file
	 * @param actual
	 *            name of the actual output file
	 * @throws Exception
	 */
	public static void testProject(String[] args, String expected, String actual)
			throws Exception {
		String base = getBaseDirectory();
